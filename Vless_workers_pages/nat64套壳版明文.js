//nat64 Information proxyip， Information proxyipSettings
...
async function handle\u0076\u006c\u0065\u0073\u0073WebSocket(request) {
  ...
  wsReadable.pipeTo(new WritableStream({
    async write(chunk) {
      ...
      if (result.isUDP) {
        if (result.portRemote === 53) {
          ...
          throw new Error('UDPProxy Information DNS( Information 53)');
        }
      }
      ...
      function convertToNAT64IPv6(ipv4Address) {
        ...
        if (parts.length !== 4) {
          throw new Error(' Information IPv4Address');
        }
        
        const hex = parts.map(part => {
          const num = parseInt(part, 10);
          if (num < 0 || num > 255) {
            throw new Error(' Information IPv4Address Information ');
          }
      ...
      async function getIPv6ProxyAddress(domain) {
        try {
          ...
          throw new Error(`DNS Information Failed: ${err.message}`);
        }
      }
      ...
      async function retry() {
        try {
          ...
          console.log(` Information NAT64 IPv6Address ${proxyIP} Connect...`);
          const tcpSocket = await connect({
            hostname: proxyIP,
          ...
          tcpSocket.closed.catch(error => {
            console.error('NAT64 IPv6Connect Information :', error);
          }).finally(() => {
            if (serverWS.readyState === WS_READY_STATE_OPEN) {
              serverWS.close(1000, 'Connect Information ');
            }
          });
          
          pipeRemoteToWebSocket(tcpSocket, serverWS, \u0076\u006c\u0065\u0073\u0073RespHeader, null);
        } catch (err) {
          console.error('NAT64 IPv6ConnectFailed:', err);
          serverWS.close(1011, 'NAT64 IPv6ConnectFailed: ' + err.message);
        }
      }
      ...
      try {
        ...
        console.error('ConnectFailed:', err);
        serverWS.close(1011, 'ConnectFailed');
      }
    },
    close() {
      if (remoteSocket) {
    ...
    console.error('WebSocket  Information :', err);
    closeSocket(remoteSocket);
    serverWS.close(1011, ' Information ');
  });
...
function parse\u0076\u006c\u0065\u0073\u0073Header(buffer, userID) {
  if (buffer.byteLength < 24) {
    return { hasError: true, message: ' Information ' };
  }
  ...
  if (uuid !== userID) {
    return { hasError: true, message: ' Information User' };
  }
  ...
  if (command === 1) {
    ...
    return { hasError: true, message: ' Information ， Information TCP(01) Information UDP(02)' };
  }
  ...
  switch (addressType) {
    ...
    default:
      return { hasError: true, message: ' Information Address Information ' };
  }
...
function pipeRemoteToWebSocket(remoteSocket, ws, \u0076\u006c\u0065\u0073\u0073Header, retry = null) {
  ...
  remoteSocket.readable.pipeTo(new WritableStream({
    ...
    console.error(' Information :', err);
    closeSocket(remoteSocket);
    if (ws.readyState === WS_READY_STATE_OPEN) {
      ws.close(1011, ' Information ');
    }
  });
}
  ...
  transformStream.readable.pipeTo(new WritableStream({
    async write(chunk) {
      ...
      if (webSocket.readyState === WS_READY_STATE_OPEN) {
        console.log(`DNS Information Success，DNS Information  ${udpSize}`);
    ...
    console.error('DNS UDP Information :', error);
  });
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Cloudflare-workers/pages-\u0076\u006c\u0065\u0073\u0073ProxyScript V25.5.27</h1>
	    <hr>
            <p>${noteshow}</p>
            <hr>
	    <hr>
			...
			<table class="table">
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-primary" onclick="copyToClipboard('${w\u0076\u006c\u0065\u0073\u0073ws}')"> Information Copy Information </button></td>
					</tr>
				</tbody>
			</table>
		...
		<li> Information (TLS)： Information </li>
            ...
            <br>
            <br>
            <h3>2：CF-workers-\u0076\u006c\u0065\u0073\u0073+ws+tlsNode</h3>
			<table class="table">
				<thead>
					<tr>
						<th>Node Information ：</th>
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-primary" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')"> Information Copy Information </button></td>
					</tr>
				</tbody>
			</table>
            <h5> Information Parameters Information ：</h5>
			...
			<hr>
			<p>Note：<br>1、Default Information Subscription Information TLS+ Information TLS Information 13 Information Node<br>2、 Information workers Information Subscription Information ， Information Proxy Information SubscriptionUpdate<br>3、 Information Usage Information Features， Information TLSNode Information </p>
			<hr>
			...
			<table class="table">
					...
					<tbody>
						<tr>
							<td><button class="btn btn-primary" onclick="copyToClipboard('${wk\u0076\u006c\u0065\u0073\u0073share}')"> Information Copy Information </button></td>
						</tr>
					</tbody>
				</table>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
            <br>
            <h3>1：CF-pages/workers/Custom Information -\u0076\u006c\u0065\u0073\u0073+ws+tlsNode</h3>
			<table class="table">
				<thead>
					<tr>
						<th>Node Information ：</th>
			...
			<table class="table">
					...
					<tbody>
						<tr>
							<td><button class="btn btn-primary" onclick="copyToClipboard('${pg\u0076\u006c\u0065\u0073\u0073share}')"> Information Copy Information </button></td>
						</tr>
					</tbody>
				</table>
